...
QBShared.Weapons = {
	...
	[`weapon_tacticalrifle`] 	     = {['name'] = 'weapon_heavyrifle', 	 		['label'] = 'Service Carbine', 				['ammotype'] = 'AMMO_RIFLE',	['damagereason'] = 'Ended / Rifled / Shot down / Floored'},
	...
	[`weapon_remotesniper`] 		 = {['name'] = 'weapon_remotesniper', 	 		['label'] = 'Remote Sniper', 				['ammotype'] = 'AMMO_SNIPER',			['damagereason'] = 'Sniped / Picked off / Scoped'},
	[`weapon_precisionrifle`] 		 = {['name'] = 'weapon_precisionrifle', 	 	['label'] = 'Precision Rifle', 				['ammotype'] = 'AMMO_SNIPER',			['damagereason'] = 'Sniped / Picked off / Scoped'},
